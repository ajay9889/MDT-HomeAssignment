...
import com.test.companydata.stfrontentengchallenge.DataSource.module.GlobalQuote.Companion.toTbGlobalQoute
...
class HomeViewModel(val application: MainApplication, val accntRepository : AccountDataReposityImpl): AndroidViewModel(application){
    ...
    fun getGlobalQoutes(symbol:String){
        accntRepository.getQuoteEndpoint(symbol).
    ...
    fun getTimeSeriesData(symbol:String){
        viewModelScope.launch(Dispatchers.IO) {
            accntRepository.getDailyData(symbol).let {
